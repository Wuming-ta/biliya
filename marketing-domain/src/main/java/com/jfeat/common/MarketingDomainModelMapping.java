...
public class MarketingDomainModelMapping {
    ...
    public static void mapping(Module module) {
        ...
        module.addModel(com.jfeat.marketing.trial.model.Trial.class);
        module.addModel(com.jfeat.marketing.trial.model.TrialImage.class);
        module.addModel(com.jfeat.marketing.trial.model.TrialApplication.class);

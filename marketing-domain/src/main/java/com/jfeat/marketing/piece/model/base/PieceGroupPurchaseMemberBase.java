...
public abstract class PieceGroupPurchaseMemberBase<M extends PieceGroupPurchaseMemberBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setMasterId(Integer var) {
        set(Fields.MASTER_ID.toString(), var);
    }

    public Integer getMasterId() {
        return (Integer) get(Fields.MASTER_ID.toString());
    }

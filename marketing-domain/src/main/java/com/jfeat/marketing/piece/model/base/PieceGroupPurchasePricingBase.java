...
public abstract class PieceGroupPurchasePricingBase<M extends PieceGroupPurchasePricingBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setParticipatorCount(Integer var) {
        set(Fields.PARTICIPATOR_COUNT.toString(), var);
    }

    public Integer getParticipatorCount() {
        return (Integer) get(Fields.PARTICIPATOR_COUNT.toString());
    }

...
public abstract class WechatTemplateMessageBase<M extends WechatTemplateMessageBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setTemplateId(String var) {
        set(Fields.TEMPLATE_ID.toString(), var);
    }

    public String getTemplateId() {
        return (String) get(Fields.TEMPLATE_ID.toString());
    }

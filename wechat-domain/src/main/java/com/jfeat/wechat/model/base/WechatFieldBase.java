...
public abstract class WechatFieldBase<M extends WechatFieldBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setPropId(Integer var) {
        set(Fields.PROP_ID.toString(), var);
    }

    public Integer getPropId() {
        return (Integer) get(Fields.PROP_ID.toString());
    }

    public void setTemplateMessageId(Integer var) {
        set(Fields.TEMPLATE_MESSAGE_ID.toString(), var);
    }

    public Integer getTemplateMessageId() {
        return (Integer) get(Fields.TEMPLATE_MESSAGE_ID.toString());
    }

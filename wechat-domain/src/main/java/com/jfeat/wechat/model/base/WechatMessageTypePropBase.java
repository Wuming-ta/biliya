...
public abstract class WechatMessageTypePropBase<M extends WechatMessageTypePropBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setDisplayValue(String var) {
        set(Fields.DISPLAY_VALUE.toString(), var);
    }

    public String getDisplayValue() {
        return (String) get(Fields.DISPLAY_VALUE.toString());
    }

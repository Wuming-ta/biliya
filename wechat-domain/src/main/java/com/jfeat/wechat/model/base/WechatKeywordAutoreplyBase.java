...
public abstract class WechatKeywordAutoreplyBase<M extends WechatKeywordAutoreplyBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setKeyword(String var) {
        set(Fields.KEYWORD.toString(), var);
    }

    public String getKeyword() {
        return (String) get(Fields.KEYWORD.toString());
    }

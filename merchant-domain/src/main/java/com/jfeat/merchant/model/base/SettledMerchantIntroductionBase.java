...
public abstract class SettledMerchantIntroductionBase<M extends SettledMerchantIntroductionBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setIntroduction(String var) {
        set(Fields.INTRODUCTION.toString(), var);
    }

    public String getIntroduction() {
        return (String) get(Fields.INTRODUCTION.toString());
    }

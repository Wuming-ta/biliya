...
public abstract class OrderStatisticBase<M extends OrderStatisticBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setSalesAmount(BigDecimal var) {
        set(Fields.SALES_AMOUNT.toString(), var);
    }

    public BigDecimal getSalesAmount() {
        return (BigDecimal) get(Fields.SALES_AMOUNT.toString());
    }

...
public abstract class ProductCategoryBase<M extends ProductCategoryBase<?>> extends BaseModel<M> implements IBean {
    ...
    public enum Fields {
        ...
        WHOLESALE("wholesale"),
        IS_SHOW_PRODUCTS("is_show_products");
    ...
    public void setWholesale(Integer var) {
        set(Fields.WHOLESALE.toString(), var);
    }

    public Integer getWholesale() {
        return (Integer) get(Fields.WHOLESALE.toString());
    }

    public void setIsShowProducts(Integer var) {
        set(Fields.IS_SHOW_PRODUCTS.toString(), var);
    }

    public Integer getIsShowProducts() {
        return (Integer) get(Fields.IS_SHOW_PRODUCTS.toString());
    }

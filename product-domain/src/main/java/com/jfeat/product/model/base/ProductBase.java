...
public abstract class ProductBase<M extends ProductBase<?>> extends BaseModel<M> implements IBean {
    ...
    public enum Fields {
        ...
        REQUIRED_PARTICIPATE_EXAM("required_participate_exam"),
    ...
    public void setSkuName(String var) {
        set(Fields.SKU_NAME.toString(), var);
    }

    public String getSkuName() {
        return (String) get(Fields.SKU_NAME.toString());
    }

    public void setSkuCode(String var) {
        set(Fields.SKU_CODE.toString(), var);
    }

    public String getSkuCode() {
        return (String) get(Fields.SKU_CODE.toString());
    }

    public void setBarCode(String var) {
        set(Fields.BAR_CODE.toString(), var);
    }

    public String getBarCode() {
        return (String) get(Fields.BAR_CODE.toString());
    }
    ...
    public void setAllowCoupon(Integer var) {
        set(Fields.ALLOW_COUPON.toString(), var);
    }

    public Integer getAllowCoupon() {
        return (Integer) get(Fields.ALLOW_COUPON.toString());
    }
    ...
    public void setIsVirtual(Integer var) {
        set(Fields.IS_VIRTUAL.toString(), var);
    }

    public Integer getIsVirtual() {
        return (Integer) get(Fields.IS_VIRTUAL.toString());
    }

    public void setRequiredParticipateExam(Integer var) {
        set(Fields.REQUIRED_PARTICIPATE_EXAM.toString(), var);
    }

    public Integer getRequiredParticipateExam() {
        return (Integer) get(Fields.REQUIRED_PARTICIPATE_EXAM.toString());
    }

    public void setDistributionPrice(BigDecimal var) {
        set(Fields.DISTRIBUTION_PRICE.toString(), var);
    }

    public BigDecimal getDistributionPrice() {
        return (BigDecimal) get(Fields.DISTRIBUTION_PRICE.toString());
    }

    public void setPresale(Integer var) {
        set(Fields.PRESALE.toString(), var);
    }

    public Integer getPresale() {
        return (Integer) get(Fields.PRESALE.toString());
    }

    public void setBanner(String var) {
        set(Fields.BANNER.toString(), var);
    }

    public String getBanner() {
        return (String) get(Fields.BANNER.toString());
    }

...
public abstract class CouponTemplateBase<M extends CouponTemplateBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setIsDiscount(Integer var) {
        set(Fields.IS_DISCOUNT.toString(), var);
    }

    public Integer getIsDiscount() {
        return (Integer) get(Fields.IS_DISCOUNT.toString());
    }

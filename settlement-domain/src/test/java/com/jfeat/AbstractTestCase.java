...
import com.jfeat.common.SettlementDomainModule;
...
public class AbstractTestCase {
    ...
    public static void beforeClass() throws Exception {
        if (!started) {
            ...
            Module settlementDomainModule = new SettlementDomainModule(config);
            settlementDomainModule.configPlugin(plugins);

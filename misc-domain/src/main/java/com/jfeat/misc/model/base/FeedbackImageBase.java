...
public abstract class FeedbackImageBase<M extends FeedbackImageBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setFeedbackId(Integer var) {
        set(Fields.FEEDBACK_ID.toString(), var);
    }

    public Integer getFeedbackId() {
        return (Integer) get(Fields.FEEDBACK_ID.toString());
    }

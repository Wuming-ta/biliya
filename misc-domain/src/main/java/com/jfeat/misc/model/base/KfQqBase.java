...
public abstract class KfQqBase<M extends KfQqBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setNumber(String var) {
        set(Fields.NUMBER.toString(), var);
    }

    public String getNumber() {
        return (String) get(Fields.NUMBER.toString());
    }

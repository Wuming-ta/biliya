...
public abstract class PermissionBase<M extends PermissionBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setRoleId(Integer var) {
        set(Fields.ROLE_ID.toString(), var);
    }

    public Integer getRoleId() {
        return (Integer) get(Fields.ROLE_ID.toString());
    }

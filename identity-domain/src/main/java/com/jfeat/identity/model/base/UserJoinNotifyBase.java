...
public abstract class UserJoinNotifyBase<M extends UserJoinNotifyBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setJoinTime(Date var) {
        set(Fields.JOIN_TIME.toString(), var);
    }

    public Date getJoinTime() {
        return (Date) get(Fields.JOIN_TIME.toString());
    }

    public void setIsRead(Short var) {
        set(Fields.IS_READ.toString(), var);
    }

    public Short getIsRead() {
        return (Short) get(Fields.IS_READ.toString());
    }

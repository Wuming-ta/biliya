...
public abstract class PartnerLevelBase<M extends PartnerLevelBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setHeadcountQuota(Integer var) {
        set(Fields.HEADCOUNT_QUOTA.toString(), var);
    }

    public Integer getHeadcountQuota() {
        return (Integer) get(Fields.HEADCOUNT_QUOTA.toString());
    }

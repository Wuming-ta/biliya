...
public abstract class MerchantOptionsBase<M extends MerchantOptionsBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setMaxLevel(Integer var) {
        set(Fields.MAX_LEVEL.toString(), var);
    }

    public Integer getMaxLevel() {
        return (Integer) get(Fields.MAX_LEVEL.toString());
    }

    public void setPoolPriority(Integer var) {
        set(Fields.POOL_PRIORITY.toString(), var);
    }

    public Integer getPoolPriority() {
        return (Integer) get(Fields.POOL_PRIORITY.toString());
    }
